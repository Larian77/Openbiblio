...
<table class="primary" style="width:100%;border:none;border-spacing:0px">
  <tr>
    ...
    <td style="padding:0px;white-space:nowrap" class="noborder" valign="top"><font class="small"><a href="javascript:window.close()"><?php echo $loc->getText("mbrPrintCloseWindow"); ?></a>&nbsp;&nbsp;</font></td>
  </tr>
</table>
<br>
<table class="primary" style="width:100%;border:none;border-spacing:0px">
  <tr>
    <td style="padding:0px" class="noborder" valign="top"><?php echo $loc->getText("mbrPrintCheckoutsHdr1");?></td>
    <td style="padding:0px" width="100%" class="noborder" valign="top"><?php echo H(date("F j, Y, g:i a"));?></td>
  </tr>
  <tr>
    <td style="padding:0px" class="noborder" valign="top" nowrap><?php echo $loc->getText("mbrPrintCheckoutsHdr2");?></td>
    <td style="padding:0px" class="noborder" valign="top"><?php echo H($mbr->getFirstLastName());?></td>
  </tr>
  <tr>
    <td style="padding:0px" class="noborder" valign="top" nowrap><?php echo $loc->getText("mbrPrintCheckoutsHdr3");?></td>
    <td style="padding:0px" class="noborder" valign="top"><?php echo H($mbr->getBarcodeNmbr());?></td>
  </tr>
  <tr>
    <td style="padding:0px" class="noborder" valign="top" nowrap><?php echo $loc->getText("mbrPrintCheckoutsHdr4");?></td>
    <td style="padding:0px" class="noborder" valign="top"><?php echo H($mbrClassifyDm[$mbr->getClassification()]);?></td>
  </tr>
</table>
<br>
<table class="primary">
