 ...
 */
  ...
  $cancelLocation = "../circ/mbr_view.php?mbrid=$mbrid";
?>

<form name="mbrpwdresetform" method="POST" action="../circ/mbr_pwd_reset.php?mbrid=<?php echo U($mbrid); ?>">
<input type="hidden" name="mbrid" value="<?php echo H($mbrid);?>">
<table class="primary">
  <tr>
    <th colspan="2" valign="top" nowrap="yes" align="left">
    <?php 
      if ($mbr->getPwd() == NULL || $mbr->getPwd() == 0 ) { 
        echo $loc->getText("mbr_pwd_create_form_Resetheader");
      } else {
        echo $loc->getText("mbr_pwd_reset_form_Resetheader");  
      }
    ?>
    </td>
  </tr>
