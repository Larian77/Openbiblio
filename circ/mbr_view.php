            ...
            <td style="white-space:nowrap" class="primary">
                <table class="primary">
                    ...
                    <tr>
                        ...
                        <td class="borderless">
                            <small id="duedateoverride"><a href="javascript:showDueDate()">
            ...
            <tr>
                ...
                <td class="primary" valign="top">
                    <img src="../images/<?php echo HURL($materialImageFiles[$biblio->getMaterialCd()]); ?>" width="20"
                        height="20" border="0" align="middle" alt="<?php echo H($materialTypeDm[$biblio->getMaterialCd()]); ?>">
    ...
    if ($holdQ->getRowCount() == 0) {
        ...
        while ($hold = $holdQ->fetchRow()) {
            ...
            <tr>
                ...
                <td class="primary" valign="top">
                    <img src="../images/<?php echo HURL($materialImageFiles[$hold->getMaterialCd()]); ?>" width="20" height="20"
                        border="0" align="middle" alt="<?php echo H($materialTypeDm[$hold->getMaterialCd()]); ?>">
                ...
                <td class="primary" valign="top">
                    <a href="../shared/biblio_view.php?bibid=<?php echo HURL($hold->getBibid()); ?>">
