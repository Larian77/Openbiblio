...
<table style="height:100%;width:100%;border:none;border-spacing:0px">
  ...
  <tr>
    ...
    <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT1_BG);?>"><img src="../images/shim.gif" width="80" height="1" border="0"></td>
  ...
  <!-- Changes PVD(8.0.x) Changed From Above To Below -->
	<a href="http://obiblio.sourceforge.net/index.php/Help/" target=_blank>Revise Page</a>
