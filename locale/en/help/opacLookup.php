...
<table class="primary">
  <tbody><tr>
    <th colspan="3" align="left" style="white-space:nowrap" valign="top">
  ...
  <tr>
    ...
    <td class="primary" rowspan="2" align="center" style="white-space:nowrap" valign="top">
      1.<br>
    ...
    <td class="primary" colspan="2" valign="top">
      <table class="primary" style="width:100%">
        ...
        <tr>
          <td class="noborder" style="white-space:nowrap" valign="top"><font class="small"><b><?php echo $loc->getText("biblioSearchCall"); ?>:</b></font></td>
        ...
        <tr>
        <td class="primary" style="white-space:nowrap"><font class="small"><b><?php echo $loc->getText("biblioSearchCopyBCode"); ?></b>: 000051          
        ...
        <td class="primary" style="white-space:nowrap"><font class="small"><b><?php echo $loc->getText("biblioSearchCopyStatus"); ?></b>: checked in</font></td>
      </tr>
  ...
  <tr>
    ...
    <td class="primary" colspan="2" valign="top">
      <table class="primary" style="width:100%">
        ...
        <tr>
          <td class="noborder" style="width:100%" valign="top"><font class="small"><b><?php echo $loc->getText("biblioSearchCall"); ?>:</b></font></td>
          <td class="noborder" colspan="3"><font class="small">JF Cle </font></td>
        </tr>
      </tbody></table>
        ...
        <tr>
        <td class="primary" style="width:100%"><font class="small"><b><?php echo $loc->getText("biblioSearchCopyBCode"); ?></b>: 000061          
            <a href="#exam" title="<?php echo $loc->getText("biblioSearchBCode2Chk"); ?>"><?php echo $loc->getText("biblioSearchOutIn"); ?></a> | <a href="#exam" title="<?php echo $loc->getText("biblioSearchBCode2Hold"); ?>"><?php echo $loc->getText("biblioSearchHold"); ?></a>
                  </font></td>
        <td class="primary" style="width:100%"><font class="small"><b><?php echo $loc->getText("biblioSearchCopyStatus"); ?></b>: checked in</font></td>

      </tr>
              <tr>
            <td class="primary" align="center" style="width:100%" valign="top"><font class="small">
              3.
            </font></td>
            <td class="primary" style="width:100%"><font class="small"><b><?php echo $loc->getText("biblioSearchCopyBCode"); ?></b>: 000062              
                <a href="#exam" title="<?php echo $loc->getText("biblioSearchBCode2Chk"); ?>"><?php echo $loc->getText("biblioSearchOutIn"); ?></a> | <a href="#exam" title="<?php echo $loc->getText("biblioSearchBCode2Hold"); ?>"><?php echo $loc->getText("biblioSearchHold"); ?></a>
            ...
            <td class="primary" style="width:100%"><font class="small"><b><?php echo $loc->getText("biblioSearchCopyBCode"); ?></b>: 000063              
                <a href="#exam" title="<?php echo $loc->getText("biblioSearchBCode2Chk"); ?>"><?php echo $loc->getText("biblioSearchOutIn"); ?></a> | <a href="#exam" title="<?php echo $loc->getText("biblioSearchBCode2Hold"); ?>"><?php echo $loc->getText("biblioSearchHold"); ?></a>
