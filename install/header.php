...
<table style="width:100%" style="border:none;border-spacing:2px">
  <tr bgcolor="#bebdbe">
    <td style="padding:0px" align="left"><img src="../images/obiblio_logo.gif" width="170" height="35" border="0"></td>
    <td style="padding:0px" align="right" valign="top" width="100%"><font color="#ffffff">
    </td>
  </tr>
</table>
