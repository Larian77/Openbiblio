...
<table class="primary" style="width:100%;border:none;border-spacing:0px">
  <tr bgcolor="<?php echo H(OBIB_TITLE_BG);?>">
    ...
    <td style="padding:0px;white-space:nowrap" class="title" valign="top"><font class="small"><a href="javascript:window.close()"><font color="<?php echo H(OBIB_TITLE_FONT_COLOR)?>"><?php echo $loc->getText("adminTheme_preview_CloseWindow"); ?></font></a>&nbsp;&nbsp;</font></td>
  </tr>
</table>
<!-- **************************************************************************************
     * Tabs
...
<table class="primary" style="width:100%;border:none;border-spacing:0px">
  ...
  <tr bgcolor="<?php echo H(OBIB_TITLE_BG);?>">
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT1_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px;white-space:nowrap" class="tab1"> <?php echo $loc->getText("adminTheme_preview_Home"); ?> </td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT1_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px;white-space:nowrap" class="tab2"> <a href="#" class="tab"><?php echo $loc->getText("adminTheme_preview_Circulation"); ?></a> </td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px;white-space:nowrap" class="tab2"> <a href="#" class="tab"><?php echo $loc->getText("adminTheme_preview_Cataloging"); ?></a> </td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px;white-space:nowrap" class="tab2"> <a href="#" class="tab"><?php echo $loc->getText("adminTheme_preview_Admin"); ?></a> </td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_ALT2_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
      <td style="padding:0px" width="2000" bgcolor="<?php echo H(OBIB_TITLE_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
  </tr>
