    ...
    <div class="middle primary formular">
        ...
        <div class="form middle">
            <div class="formContent">
                <form action="../opac/mbr_pwd_forget.php" method="post" name="pwd_forgotten">
...
<?php   } ?> 
                    ...
                    <div class="inputField"><input type="text" name="barcodeNmbr" 
                                value="<?php echo isset($postVars['barcodeNmbr']) ? htmlentities($postVars['barcodeNmbr']) : ''; ?>">
                    </div>       
                    <div class="hidden">
                        <input type="hidden" name="send" value="
                            <?php if (isset($send)) echo $send; ?>">
                        <input type="hidden" name="barcodeNmbrForm" value="barcodeNmbrForm">
                    </div>
                    <div class="submit"><input type="submit" value="<?php echo $loc->getText('NewPassword'); ?>" class="button"></div>
                </form>
            </div>
