...
<h1><?php echo $loc->getText("mbrViewHead4"); ?>
  <font class="primary"> <a
		href="javascript:popSecondary('../opac/mbr_print_checkouts.php?mbrid=<?php echo H(addslashes(U($mbrid)));?>')">[<?php echo $loc->getText("mbrPrintCheckouts"); ?>]</a>
	</font>
</h1>
<table class="primary">
	<tr>
  ...
  <tr>
     ...
     <?php
        if ($biblio->getDaysLate() > 7) {
            ...
            ?>
      <a
			href="../opac/renew.php?barcodeNmbr=<?php echo HURL($biblio->getBarcodeNmbr());?>&amp;mbrid=<?php echo HURL($mbrid);?>&amp;renewal"><?php echo $loc->getText("Renew item"); ?></A>
      <?php
...
<?php
  ...
  <tr>
      ...
      <?php echo H($hold->getBarcodeNmbr());?>
		...
		<td class="primary" valign="top"><a
			href="../shared/biblio_view.php?bibid=<?php echo HURL($hold->getBibid());?>&tab=opac"><?php echo H($hold->getTitle());?></a>
		</td>
		<td class="primary" valign="top">
