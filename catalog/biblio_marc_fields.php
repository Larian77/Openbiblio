<table class="primary">
	<tr>
		<th colspan="3" style="white-space: nowrap;" align="left">
	...
	<tr>
      ...
      <input type="button"
			onClick="javascript:popSecondary('../catalog/usmarc_select.php?retpage=<?php echo HURL($returnPg);?>')"
			value="<?php echo $loc->getText("biblioMarcNewFormSelect"); ?>"
			class="button">
      <?php echo H($tagDesc); ?>
    </td>
	</tr>
	<tr>
      ...
      <?php echo $loc->getText("biblioMarcNewFormInd1"); ?>
		...
		<td valign="top" class="primary"><input type="checkbox" name="ind1Cd"
			value="CHECKED"
	...
	<tr>
      ...
      <?php echo $loc->getText("biblioMarcNewFormInd2"); ?>
		...
		<td valign="top" class="primary"><input type="checkbox" name="ind2Cd"
			value="CHECKED"
