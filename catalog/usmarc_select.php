...
<table class="primary" style="width:100%;border:none;border-spacing:0px">
  <tr bgcolor="<?php echo H(OBIB_TITLE_BG);?>">
    ...
    <td style="padding:0px;white-space:nowrap" class="title" valign="top"><font class="small"><a href="javascript:window.close()"><font color="<?php echo H(OBIB_TITLE_FONT_COLOR)?>"><?php echo $loc->getText("usmarcCloseWindow"); ?></font></a>&nbsp;&nbsp;</font></td>
  </tr>
</table>
<!-- **************************************************************************************
     * Line
  ...
  <?php
    foreach($marcBlocks as $blockKey => $block) {
      ...
      if (strcmp($selectedBlock,$blockKey) == 0) {
        ?>
        <tr><td style="padding:0px" class="noborder" nowrap>
        <a href="../catalog/usmarc_select.php?retpage=<?php echo HURL($retPage); ?>" class="nav">
          -&nbsp;</a>
        </td><td style="padding:0px" class="noborder" colspan="3">
        ...
        if ($marcTags != false) {
          foreach($marcTags as $tagKey => $tag) {
            ...
            if (strcmp($selectedTag,$tagKey) == 0) {
              ?>
              <tr><td style="padding:0px" class="noborder"></td>
              <td style="padding:0px" class="noborder" nowrap>
              <a href="../catalog/usmarc_select.php?retpage=<?php echo HURL($retPage); ?>&amp;block=<?php echo HURL($blockKey); ?>" class="nav">
              -&nbsp;</a>
              </td><td style="padding:0px" class="noborder" colspan="2">
              ...
              if ($marcSubflds != false) {
                foreach($marcSubflds as $subfldKey => $subfld) {
                  ?>
                  <tr><td style="padding:0px" class="noborder" colspan="2"></td>
                  ...
                  </td><td style="padding:0px" class="noborder" width="100%">
                ...
                <td class="noborder">
                <a>+</a>
                </td><td style="padding:0px" class="noborder">
              ...
              +</a>
              </td><td style="padding:0px" class="noborder" colspan="2" width="100%">
          ...
          ?>
          <tr><td style="padding:0px" class="noborder">
          </td><td style="padding:0px" class="noborder" colspan="3" width="100%">
            <?php echo $loc->getText("usmarcSelectNoTags"); ?>
          </td></tr>
