...
?>
<h1><img src="../images/catalog.png" border="0" width="30" height="30" align="top">
  ...
  <table class="primary">
    ...
    <tr>
      <td nowrap="true" class="primary">
        ...
        <input type="text" name="searchText" size="40" maxlength="40">
  ...
  <table class="primary">
    ...
    <tr>
      <td nowrap="true" class="primary">
        ...
        <input type="text" name="searchText" size="60" maxlength="256">
        <input type="hidden" name="sortBy" value="default">
        <input type="submit" value="<?php echo $loc->getText("indexButton"); ?>" class="button">
      </td>
    </tr>
  ...
  <table class="primary">
    ...
    <tr>
        ...
        <font class="small">
          ...
          <input type="checkbox" name="selectall" value="select_all" onclick="selectAll('collec[]');"><b>
        ...
        <font class="small">
          <input type="checkbox" name="selectall" value="select_all" onclick="selectAll('material[]');"><b>
            <?php echo $loc->getText("indexSearchInvert"); ?>
          </b><br>
